...
<body class="img">
	<FORM>
	    ...
	    <TABLE  align="right" border="1" cellspacing="0" width="70%">
			...
			<TR> 
				...
				<TD width="349"><font color="#6600FF"><%= bookinfo.getBookName()%></font></TD>
			</TR>
			<TR> 
				<TD width="116"><font color="#6600FF">出版社</font></TD>
				<TD width="349"><font color="#6600FF"><%= bookinfo.getPublisher()%></font></TD>
			</TR>    
			<TR> 
				<TD width="116"><font color="#6600FF">作者/译者</font></TD>
				<TD width="349"><font color="#6600FF"><%= bookinfo.getBookAuthor()%></font></TD>
			</TR>
			<TR> 
				<TD width="116"><font color="#6600FF">图书价格</font></TD>
				<TD width="349"><font color="#6600FF"><%= bookinfo.getPrice()%></font></TD>
			</TR>
			<TR>
			...
			<TR>			
				<TD height="100" colspan="2" > <%= bookinfo.getIntroduce()%></TD>
			</TR>	
	  </TABLE>
	<%	
	}
	...
	<TABLE align="right" border="0"> 
		...
		<TR>
			<TD><A href="list.jsp">返回书店首页</A></TD>
		</TR>
	</TABLE>		
</body>
</HTML>